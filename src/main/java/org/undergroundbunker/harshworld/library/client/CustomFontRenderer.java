...
public class CustomFontRenderer extends FontRenderer {
    ...
    public static String getCustomFormatFromString(String text) {
        ...
        while ((i < j-1))
        {
            ...
            else if((int) c >= CustomFontColour.MARKER && (int) c <= CustomFontColour.MARKER + 0xFF) {
...
//    @Override
//    public int renderString(@Nonnull String text, float x, float y, int colour, boolean dropShadow) {
//        this.dropShadow = dropShadow;
//        return super.renderString(text, x, y, colour, dropShadow);
//    }
    ...
    protected float renderUnicodeChar(char letter, boolean italic) {
        ...
        if((int)letter >= CustomFontColour.MARKER && (int)letter <= CustomFontColour.MARKER + 0xFF) {
